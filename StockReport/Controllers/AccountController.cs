...
using StockReport.ViewModels.Account;
        ...
        public ActionResult UserList()
        {
            ...
            using (var db =new ApplicationDbContext())
            {
                ...
                foreach (var x in users)
                {
                    ...
                    foreach (IdentityUserRole role in x.Roles)
                    {
                        string name = role.RoleId;
                        user.Position = roleManager.Roles.Where(r => r.Id == role.RoleId).FirstOrDefault().Name;
                    }
                    user.UserID = x.Id;
